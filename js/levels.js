...
export const LEVELS = [
  ...
  {
    id: 5, label: 'Sing the whole line',
  ...
  {
    id: 6, label: 'Drop the cantillation marks',
  ...
  {
    id: 8, label: 'Read from the scroll',
  ...
  {
    id: 9, label: 'Read from a Torah column',
